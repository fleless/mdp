...
class CalendrierRealisationRdvWidget extends StatefulWidget {
  CalendrierRealisationRdvWidget();

  @override
  State<StatefulWidget> createState() => _CalendrierRealisationRdvWidgetState();
}

class _CalendrierRealisationRdvWidgetState
    extends State<CalendrierRealisationRdvWidget> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Modular.to.pushNamed(Routes.ajouterRealisationRDV);
            },
            child: Column(
              children: [
                Icon(
